...
export function ActionBox({ workshop }: { workshop: any }) {
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 flex flex-col h-fit sticky top-6">
      ...
      <div className="space-y-4 mb-8 flex-grow">
        ...
        <div className="flex justify-between items-center border-b border-gray-100 pb-3">
          ...
          <span className="font-semibold text-gray-800 text-right">{workshop.horario || "10:00 - 12:00 hrs"}</span>
        </div>
        <div className="flex justify-between items-center border-b border-gray-100 pb-3">
        ...
        {workshop.cuposDisponibles !== undefined && (
          <div className="flex justify-between items-center pt-2">
            <span className="text-gray-500 text-sm">Cupos Diposnibles</span>
            <span className="font-semibold text-blue-700 text-right">
              {workshop.cuposDisponibles} / {workshop.cuposTotal}
            </span>
          </div>
        )}
      </div>
      ...
      <div className="mt-auto">
        ...
        {status === "not_enrolled" && (
          <button 
            ...
            className="bg-blue-900 text-white px-6 py-3.5 rounded-lg hover:bg-blue-800 transition w-full font-bold shadow-md cursor-pointer"
          >
