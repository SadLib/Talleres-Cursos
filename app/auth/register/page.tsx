...
export default function RegisterPage() {
  ...
  const inputBase = "w-full px-4 py-3 rounded-xl border bg-gray-50 text-gray-800 outline-none focus:bg-white focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all duration-200 disabled:opacity-50";
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`${inputBase} ${errors.nombre ? "border-red-400" : "border-gray-200"}`}
              />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  disabled={loading || success}
                  className={`${inputBase} ${errors.primerApellido ? "border-red-400" : "border-gray-200"}`}
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  name="correo"
                  type="email"
                  placeholder="correo@alumno.unam.mx"
                  value={formData.correo}
                  onChange={handleChange}
                  disabled={loading || success}
                  className={`${inputBase} ${errors.correo ? "border-red-400" : "border-gray-200"}`}
                />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  disabled={loading || success}
                  className={`${inputBase} ${errors.contrasena ? "border-red-400" : "border-gray-200"}`}
                />
            ...
            <button
              type="submit"
              disabled={loading || success}
              className="w-full bg-blue-900 text-white font-bold py-3.5 rounded-xl hover:bg-blue-800 shadow-[0_5px_15px_rgba(30,58,138,0.25)] hover:shadow-[0_5px_20px_rgba(30,58,138,0.35)] active:scale-[0.98] transition-all flex justify-center items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:active:scale-100"
            >
              {loading ? (
                <>
