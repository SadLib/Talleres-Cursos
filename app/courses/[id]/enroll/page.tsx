...
export default function EnrollPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // 1. Obtener ID del usuario actual para poder actualizarlo
      const user = await me();
      ...
      // 3. Inscribir al taller
      await inscribirse(workshop!.id);
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6 md:p-12">
        <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row">
          ...
          {/* Lado Izquierdo: Resumen del Taller */}
             ...
             <div className="relative z-10">
               ...
               <div className="space-y-4 text-sm text-blue-100 mt-6">
                 ...
                 {workshop.descripcion && (
                   <div>
                     <span className="block text-blue-300 text-xs uppercase mb-1">Descripción</span>
                     <p className="font-medium text-white line-clamp-3 overflow-hidden text-ellipsis">{workshop.descripcion}</p>
                   </div>
                 )}
               </div>
             </div>
          ...
          <div className="md:w-2/3 p-8 md:p-10">
            ...
            <p className="text-gray-500 text-sm mb-6">
              Revisa y completa tu información antes de inscribirte al taller. Los datos que ingreses aquí se actualizarán en tu perfil.
            </p>
            ...
            {loading ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5" htmlFor="numero_cuenta">No. Cuenta</label>
                    <input
                      id="numero_cuenta"
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1.5" htmlFor="correo">Correo Electrónico</label>
                    <input
                      id="correo"
                      type="email"
                ...
                {/* Datos editables */}
                <div>
                  <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="nombre">Nombre(s) *</label>
                  <input
                    id="nombre"
                    name="nombre"
                    type="text"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="primer_apellido">Primer Apellido *</label>
                    <input
                      id="primer_apellido"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="segundo_apellido">Segundo Apellido</label>
                    <input
                      id="segundo_apellido"
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="telefono">Teléfono *</label>
                  <input
                    id="telefono"
                    name="telefono"
                    type="tel"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="carrera">Carrera *</label>
                    <input
                      id="carrera"
                      name="carrera"
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1.5" htmlFor="semestre">Semestre *</label>
                    <input
                      id="semestre"
                      name="semestre"
                      type="text"
